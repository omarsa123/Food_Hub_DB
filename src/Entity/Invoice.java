...
protected void prePersist() {
  ...
  public void calculateFinalTotal(double taxPercentage, BigDecimal deliveryFee) {
    ...
    BigDecimal subtotal = (orderId != null) ? orderId.getSubtotal() : BigDecimal.ZERO;
    if (subtotal == null) subtotal = BigDecimal.ZERO;

    BigDecimal tax = subtotal.multiply(BigDecimal.valueOf(taxPercentage / 100.0));
    BigDecimal delivery = (deliveryFee != null) ? deliveryFee : BigDecimal.ZERO;

    this.fees = tax.add(delivery);
    this.totalPrice = subtotal.add(this.fees);
}
